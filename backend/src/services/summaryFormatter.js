...
export function instruksiSistem({ jenis = "harian" } = {}) {
  ...
  return [
    ...
    "4. Kalau banding.hariTersedia kurang dari 5, JANGAN menyimpulkan tren untuk",
    "   metrik itu. Kumpulkan semuanya menjadi SATU baris di paling akhir,",
    "   berbunyi 'Bukti belum cukup untuk: A, B, C'. JANGAN menulisnya berulang",
    "   di tiap baris: laporan yang tujuh kali menyebut bukti belum cukup",
    "   menenggelamkan isinya sendiri, dan itu sudah terjadi.",
    ...
    "   maupun RISIKO. Angka akumulatif di section risiko terbaca sebagai",
    "   kerugian periode ini, dan itu salah. Kalau memang perlu disebut, taruh",
    "   di PER AREA sambil menyatakan sifatnya.",
    ...
    "11. JANGAN menuliskan NAMA MEASURE ke dalam laporan. Nama seperti",
    "    \"(M) % OTIR Total Only (ctn)\", \"(RT) IC_OK_Percentage\", atau",
    "    \"1-Final OEE (%)\" adalah identitas teknis di Power BI dan tidak berarti",
    "    apa pun bagi pembacanya. Sebut nama bisnisnya: OEE, downtime teknikal,",
    "    capaian terhadap PO, jam lembur. Muatan tetap membawa nama measure",
    "    supaya bisa ditelusuri, tapi itu untuk penelusuran, bukan untuk dibaca.",
    "12. Kalau satu KPI punya dua angka dari sumber berbeda, misalnya estimasi",
    "    dari form mentah dan hasil akhir yang sudah diverifikasi, sebut keduanya",
    "    dengan label peranannya, bukan dengan nama measure-nya. Kalau yang",
    "    terverifikasi masih kosong, katakan verifikasinya belum berjalan, JANGAN",
    "    menyebutnya nol.",
    "13. Untuk KPI berjenis breakdown, sebut nama barisnya beserta angkanya, dan",
    ...
    "",
    "*SUMMARY*  TEPAT tiga baris berawalan tanda hubung, dan isinya sudah",
    "ditentukan, bukan dipilih sendiri:",
    "- Baris 1, TIGA mesin dengan OEE terendah. Untuk tiap mesin sebut OEE-nya,",
    "  standar mesin itu bila ada, penyumbang downtime TERBESAR, dan ke mana",
    "  harus dicek. Organizational tertinggi berarti Utility Failure, Technical",
    "  tertinggi berarti Maintenance Downtime. Kalau standarnya nol atau kosong,",
    "  katakan standarnya belum ditetapkan, JANGAN membandingkannya.",
    "- Baris 2, mesin dengan downtime TERTINGGI beserta issue dan tindakannya.",
    "- Baris 3, capaian produksi terhadap PO, plus jumlah NC dan jumlah Deviasi.",
    "",
    "*PER AREA*  satu baris per area, berawalan tanda hubung, urut begini dan",
    "hanya area yang punya angka:",
    "- Production: gedung mana OEE-nya paling rendah di antara CMD1, CMD2, dan",
    "  CMD3, lalu penyumbang terbesarnya, dirantai sama seperti SUMMARY baris 1.",
    "- Quality: jumlah NC dan jumlah Deviasi, lalu kategori TERTINGGI per gedung.",
    "- Maintenance: total downtime, lalu mesin teratas penyumbangnya.",
    "- Cost: total lembur, lalu departemen dengan lembur tertinggi dan alasannya.",
    "- Planning: capaian terhadap PO, produk mana yang paling rendah dan kenapa.",
    "  JANGAN menyebut kedatangan truk di sini, itu urusan warehouse.",
    "",
    ...
    "",
    "*REKOMENDASI*  maksimum 4 butir berawalan tanda hubung. Setiap butir WAJIB",
    "berangkat dari temuan yang sudah disebut di section di atas, bukan analisa",
    "baru dan bukan saran umum seperti tingkatkan pengawasan. Sebut mesin,",
    "gedung, departemen, atau produk yang bersangkutan.",
    "",
    `*RISIKO*  maksimum 3 butir, juga berangkat dari temuan di atas. Risiko`,
    `operasional ${mingguan ? "minggu ini" : "hari ini"}, bukan pengulangan analisis.`,
    "",
